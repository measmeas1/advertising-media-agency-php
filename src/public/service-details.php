<?php
// Later you can get data from database here
// example: $service = $_GET['id'];
?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <div>
          ...
          <p class="text-gray-600 mt-2">
            Full TikTok account management with viral content strategy and daily posting.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div class="bg-white p-4 rounded-xl border">
            ...
            <p class="font-semibold">Gen Z, Entertainment, Tech</p>
          </div>
        </div>
      ...
      <div>
        <div class="sticky top-24 bg-white border rounded-xl p-6 shadow-sm">
          ...
          <p class="text-sm text-gray-500 mb-4">Social Media Marketing</p>
